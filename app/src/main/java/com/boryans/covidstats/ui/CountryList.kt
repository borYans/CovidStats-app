                ...
                is Resource.Success -> {
                    ...
                    countryDetails.let { details ->
                        details.data.let { country ->
                            ...
                            countryNameTxt.text = "Country name: ${country?.country?.country ?: "unavailable data."}"
                            confirmedCases.text = "Confirmed cases: ${country?.country?.confirmed?.toString() ?: "unavailable data."}"
                            recoveredCases.text = "Recovered cases: ${country?.country?.recovered?.toString() ?: "unavailable data."}"
                            deaths.text = "Deaths: ${country?.country?.deaths?.toString()?: "unavailable data."}"
                            lifeExpected.text = "Life expectancy: ${country?.country?.lifeExpectancy?: "unavailable data."}"
                            lastUpdated.text = "Updated: ${country?.country?.updated?: "unavailable data."}"
